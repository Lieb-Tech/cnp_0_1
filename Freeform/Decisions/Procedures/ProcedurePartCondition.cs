...
{
    public class ProcedurePartCondition : IDecisionTrunk<DecisionContext, TextSpanInfoes<ProcedureInfo>>
    {
        ...
        public IStrategy<TextSpanInfoes<ProcedureInfo>> GetDecision(DecisionContext data)
        {
            ...
            if (data.Matched)
                return new StrategyMulti(data.Index, new ProcedureInfoMap(0,null,1,2));
            else
                return null;
        }
