...
namespace cnp_0_1_test
{
    ...
    public class MyNotNullException : Xunit.Sdk.NotNullException
    {
        public MyNotNullException(string userMessage)
            : base()
        {
            UserMessage = userMessage;
        }
    ...
    public static class AssertX
    {
        ...
        public static void NotNull<T>(T expected, string userMessage)
        {
            if (expected == null)
                throw new MyNotNullException(userMessage);
        }
    }
}
